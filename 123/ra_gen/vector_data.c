...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [18] = gpt_counter_overflow_isr, /* GPT7 COUNTER OVERFLOW (Overflow) */
            ...
            [22] = iic_master_tei_isr, /* IIC0 TEI (Transmit end) */
            [24] = gpt_counter_overflow_isr, /* GPT0 COUNTER OVERFLOW (Overflow) */
            [26] = rtc_alarm_periodic_isr, /* RTC PERIOD (Periodic interrupt) */
            [28] = r_icu_isr, /* ICU IRQ4 (External pin interrupt 4) */
        };
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [18] = BSP_PRV_IELS_ENUM(EVENT_GPT7_COUNTER_OVERFLOW), /* GPT7 COUNTER OVERFLOW (Overflow) */
            ...
            [22] = BSP_PRV_IELS_ENUM(EVENT_IIC0_TEI), /* IIC0 TEI (Transmit end) */
            [24] = BSP_PRV_IELS_ENUM(EVENT_GPT0_COUNTER_OVERFLOW), /* GPT0 COUNTER OVERFLOW (Overflow) */
            [26] = BSP_PRV_IELS_ENUM(EVENT_RTC_PERIOD), /* RTC PERIOD (Periodic interrupt) */
            [28] = BSP_PRV_IELS_ENUM(EVENT_ICU_IRQ4), /* ICU IRQ4 (External pin interrupt 4) */
        };
        #endif
