...
/* Actual period: 0.00008 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf00,
  .duty_cycle_counts = 0x780, .source_div = (timer_source_div_t) 0, .channel = 7, .p_callback = gpt7_timing_callback,
...
{ .p_ctrl = &g_timer_gpt7_ctrl, .p_cfg = &g_timer_gpt7_cfg, .p_api = &g_timer_on_gpt };
...
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.000008770833333333333 seconds. Actual duty: 49.8812351543943%. */.period_counts = (uint32_t) 0x1a5,
  .duty_cycle_counts = 0xd2, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = gpt0_timing_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .p_ctrl = &g_timer_gpt0_ctrl, .p_cfg = &g_timer_gpt0_cfg, .p_api = &g_timer_on_gpt };
...
{ .clock_source = RTC_CLOCK_SOURCE_SUBCLK, .freq_compare_value_loco = 255, .p_err_cfg = &rtc_err_cfg, .p_callback =
          rtc_callback,
  .p_context = NULL, .alarm_ipl = (BSP_IRQ_DISABLED), .periodic_ipl = (3), .carry_ipl = (3),
        ...
        { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
          ...
          .capture_b_source = (gpt_source_t) (
                  GPT_SOURCE_GTIOCA_FALLING_WHILE_GTIOCB_LOW | GPT_SOURCE_GTIOCA_FALLING_WHILE_GTIOCB_HIGH
                          | GPT_SOURCE_NONE),
          .capture_a_ipl = (3), .capture_b_ipl = (3),
...
/* Actual period: 0.0013653333333333334 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x10000,
  .duty_cycle_counts = 0x8000, .source_div = (timer_source_div_t) 0, .channel = 9, .p_callback =
          gpt9_input_capture_callback,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .p_ctrl = &g_timer_gpt9_ctrl, .p_cfg = &g_timer_gpt9_cfg, .p_api = &g_timer_on_gpt };
...
{ .add_average_count = ADC_ADD_OFF,
  ...
  .adc_vref_control = ADC_VREF_CONTROL_VREFH0_VREFL0,
  .enable_adbuf = 0,
...
{ .scan_mask = ADC_MASK_CHANNEL_8 | 0, .scan_mask_group_b = 0, .priority_group_a = ADC_GROUP_A_PRIORITY_OFF, .add_mask =
          0,
