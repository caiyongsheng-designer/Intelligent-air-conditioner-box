...
void Read_H_Display()
{
    dht11_data * dht11_data2 = (dht11_data*)malloc(sizeof(dht11_data2));
    dht11_data2 = DHT11_Read();
     if(dht11_data2->dht11_receive_sucess==1)
     {
        LCD_integer_and_decimal_display(7, dht11_data2->humdity_integer,
                                        dht11_data2->humdity_decimal, 20, 56, 32, 16);
     }
